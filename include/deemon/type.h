...
/*!fixincludes fake_include "alloc.h"  // DeeObject_Free, DeeObject_Malloc, DeeSlab_GetFree, DeeSlab_GetMalloc */
...
#define tp_var   _dee_aunion.tp_var   /*!export-*/
	...
	/* [0..1] Optional destructor callback. When "TF_TPVISIT" is set, this prototype is actually:
