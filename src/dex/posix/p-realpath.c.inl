...
PRIVATE WUNUSED DREF DeeObject *DCALL posix_lrealpath_f(size_t argc, DeeObject *const *argv, DeeObject *kw) {
	...
	if (DeeArg_UnpackStructKw(argc, argv, kw, kwlist__path, "o:lrealpath", &args))
		goto err;
	return posix_lrealpath_f_impl(args.path);
err:
	return NULL;
}
...
#endif /* !DEFINED_kwlist__fd_atflags */
PRIVATE WUNUSED DREF DeeObject *DCALL posix_frealpath_f(size_t argc, DeeObject *const *argv, DeeObject *kw) {
	...
	args.atflags = 0;
	if (DeeArg_UnpackStructKw(argc, argv, kw, kwlist__fd_atflags, "o|u:frealpath", &args))
		goto err;
	return posix_frealpath_f_impl(args.fd, args.atflags);
err:
	return NULL;
}
...
PRIVATE WUNUSED DREF DeeObject *DCALL posix_realpath_f(size_t argc, DeeObject *const *argv, DeeObject *kw) {
	...
	if (DeeArg_UnpackStructKw(argc, argv, kw, kwlist__path, "o:realpath", &args))
		goto err;
	return posix_realpath_f_impl(args.path);
err:
	return NULL;
}
...
PRIVATE WUNUSED DREF DeeObject *DCALL posix_realpathat_f(size_t argc, DeeObject *const *argv, DeeObject *kw) {
	...
	args.atflags = 0;
	if (DeeArg_UnpackStructKw(argc, argv, kw, kwlist__dfd_path_atflags, "oo|u:realpathat", &args))
		goto err;
	return posix_realpathat_f_impl(args.dfd, args.path, args.atflags);
err:
	return NULL;
}
...
PRIVATE WUNUSED DREF DeeObject *DCALL posix_lresolvepath_f(size_t argc, DeeObject *const *argv, DeeObject *kw) {
	...
	if (DeeArg_UnpackStructKw(argc, argv, kw, kwlist__path, "o:lresolvepath", &args))
		goto err;
	return posix_lresolvepath_f_impl(args.path);
err:
	return NULL;
}
...
PRIVATE WUNUSED DREF DeeObject *DCALL posix_resolvepath_f(size_t argc, DeeObject *const *argv, DeeObject *kw) {
	...
	if (DeeArg_UnpackStructKw(argc, argv, kw, kwlist__path, "o:resolvepath", &args))
		goto err;
	return posix_resolvepath_f_impl(args.path);
err:
	return NULL;
}
...
PRIVATE WUNUSED DREF DeeObject *DCALL posix_resolvepathat_f(size_t argc, DeeObject *const *argv, DeeObject *kw) {
	...
	args.atflags = 0;
	if (DeeArg_UnpackStructKw(argc, argv, kw, kwlist__dfd_path_atflags, "oo|u:resolvepathat", &args))
		goto err;
	return posix_resolvepathat_f_impl(args.dfd, args.path, args.atflags);
err:
	return NULL;
}
