 ...
 * - SQLITE_NULL:    none
 */
DEX_MEMBER_F_NODOC("DB", &DB_Type, Dee_DEXSYM_READONLY),
DEX_MEMBER_F_NODOC("Query", &Query_Type, Dee_DEXSYM_READONLY),
DEX_MEMBER_F_NODOC("QueryIterator", &QueryIterator_Type, Dee_DEXSYM_READONLY),
DEX_MEMBER_F_NODOC("Row", &Row_Type, Dee_DEXSYM_READONLY),
DEX_MEMBER_F_NODOC("SQLError", &SQLError_Type, Dee_DEXSYM_READONLY),
DEX_MEMBER_F_NODOC("SQLSyntaxError", &SQLSyntaxError_Type, Dee_DEXSYM_READONLY),
DEX_MEMBER_F_NODOC("SQLConstraintError", &SQLConstraintError_Type, Dee_DEXSYM_READONLY),

/* Internal types */
DEX_MEMBER_F_NODOC("_RowFmt", &RowFmt_Type, Dee_DEXSYM_READONLY),
DEX_MEMBER_F_NODOC("_RowFmtColumns", &RowFmtColumns_Type, Dee_DEXSYM_READONLY),
DEX_MEMBER_F_NODOC("_CellFmt", &CellFmt_Type, Dee_DEXSYM_READONLY),
