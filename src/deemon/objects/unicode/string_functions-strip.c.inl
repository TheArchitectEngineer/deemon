...
#define LOCAL_MEMSTARTSWITHB(haystack_base, haystack_len) ((matchlen = unicode_memcasestartswithb(haystack_base, haystack_len, mskstr.cp8, msklen)) != 0)
#define LOCAL_MEMSTARTSWITHW(haystack_base, haystack_len) ((matchlen = unicode_memcasestartswithw(haystack_base, haystack_len, mskstr.cp16, msklen)) != 0)
#define LOCAL_MEMSTARTSWITHL(haystack_base, haystack_len) ((matchlen = unicode_memcasestartswithl(haystack_base, haystack_len, mskstr.cp32, msklen)) != 0)
#define LOCAL_MEMENDSWITHB(haystack_base, haystack_len)   ((matchlen = unicode_memcaseendswithb(haystack_base, haystack_len, mskstr.cp8, msklen)) != 0)
#define LOCAL_MEMENDSWITHW(haystack_base, haystack_len)   ((matchlen = unicode_memcaseendswithw(haystack_base, haystack_len, mskstr.cp16, msklen)) != 0)
#define LOCAL_MEMENDSWITHL(haystack_base, haystack_len)   ((matchlen = unicode_memcaseendswithl(haystack_base, haystack_len, mskstr.cp32, msklen)) != 0)
...
#ifdef LOCAL_IS_MASKED
#ifdef LOCAL_IS_NOCASE
#define LOCAL_isspace_b(ch) unicode_memcasechrb(mskstr.cp8, ch, msklen)
#define LOCAL_isspace_w(ch) unicode_memcasechrw(mskstr.cp16, ch, msklen)
#define LOCAL_isspace_l(ch) unicode_memcasechrl(mskstr.cp32, ch, msklen)
#else /* LOCAL_IS_NOCASE */
